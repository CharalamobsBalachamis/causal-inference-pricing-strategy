...
### The Solution
This project replaces simple historical comparisons with a rigorous **Causal Inference** approach. Using a **Difference-in-Differences (DiD)** econometric framework, this pipeline isolates the *true* incremental revenue generated by a localized **"Free Shipping" campaign**. 
