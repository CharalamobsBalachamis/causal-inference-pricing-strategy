...
3. **ROI Decomposition**  
   Quantifies the gap between naive revenue attribution and true causal impact, highlighting how traditional methods can mislead decision-making.
